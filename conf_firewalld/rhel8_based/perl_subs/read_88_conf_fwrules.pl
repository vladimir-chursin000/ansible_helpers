        ...
        if ( exists(${$policy_templates_href_l}{${$hval0_l}[0]}{'policy_allowed_services'}{'seq'}) ) {
            ...
            if ( $arr0_l[0]=~/^set\:(\S+)$/ ) {
                ...
                if ( !exists(${$allowed_services_sets_href_l}{$set_name_l}{$inv_host_l}) ) {
                    ...
                    if ( $arr1_l[0]!~/^empty$/ ) {
                        $res_tmp_lv1_l{$inv_host_l}{${$hval0_l}[0]}{'allowed_services_set'}=[@arr1_l];
                    }
                    else { $res_tmp_lv1_l{$inv_host_l}{${$hval0_l}[0]}{'allowed_services_set_empty'}=1; }
        ...
        if ( exists(${$policy_templates_href_l}{${$hval0_l}[0]}{'policy_allowed_ports'}{'seq'}) ) {
            ...
            if ( $arr0_l[0]=~/^set\:(\S+)$/ ) {
                ...
                if ( !exists(${$allowed_ports_sets_href_l}{$set_name_l}{$inv_host_l}) ) {
                    ...
                    if ( $arr1_l[0]!~/^empty$/ ) {
                        $res_tmp_lv1_l{$inv_host_l}{${$hval0_l}[0]}{'allowed_ports_set'}=[@arr1_l];
                    }
                    else { $res_tmp_lv1_l{$inv_host_l}{${$hval0_l}[0]}{'allowed_ports_set_empty'}=1; }
        ...
        if ( exists(${$policy_templates_href_l}{${$hval0_l}[0]}{'policy_allowed_source_ports'}{'seq'}) ) {
            ...
            if ( $arr0_l[0]=~/^set\:(\S+)$/ ) {
                ...
                if ( !exists(${$allowed_ports_sets_href_l}{$set_name_l}{$inv_host_l}) ) {
                    ...
                    if ( $arr1_l[0]!~/^empty$/ ) {
                        $res_tmp_lv1_l{$inv_host_l}{${$hval0_l}[0]}{'allowed_source_ports_set'}=[@arr1_l];
                    }
                    else { $res_tmp_lv1_l{$inv_host_l}{${$hval0_l}[0]}{'allowed_source_ports_set_empty'}=1; }
        ...
        if ( exists(${$policy_templates_href_l}{${$hval0_l}[0]}{'policy_allowed_protocols'}{'seq'}) ) {
            ...
            if ( $arr0_l[0]=~/^set\:(\S+)$/ ) {
                ...
                if ( !exists(${$allowed_protocols_sets_href_l}{$set_name_l}{$inv_host_l}) ) {
                    ...
                    if ( $arr1_l[0]!~/^empty$/ ) {
                        $res_tmp_lv1_l{$inv_host_l}{${$hval0_l}[0]}{'allowed_protocols_set'}=[@arr1_l];
                    }
                    else { $res_tmp_lv1_l{$inv_host_l}{${$hval0_l}[0]}{'allowed_protocols_set_empty'}=1; }
        ...
        if ( exists(${$policy_templates_href_l}{${$hval0_l}[0]}{'policy_icmp_block'}{'seq'}) ) {
            ...
            if ( $arr0_l[0]=~/^set\:(\S+)$/ ) {
                ...
                if ( !exists(${$icmp_blocks_sets_href_l}{$set_name_l}{$inv_host_l}) ) {
                    ...
                    if ( $arr1_l[0]!~/^empty$/ ) {
                        $res_tmp_lv1_l{$inv_host_l}{${$hval0_l}[0]}{'icmp_blocks_set'}=[@arr1_l];
                    }
                    else { $res_tmp_lv1_l{$inv_host_l}{${$hval0_l}[0]}{'icmp_blocks_set_empty'}=1; }
